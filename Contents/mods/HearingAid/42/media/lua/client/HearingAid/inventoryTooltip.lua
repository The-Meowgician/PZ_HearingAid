...
if HearingAidInventoryTooltip then
	if HearingAidInventoryTooltip.versionNumber >= versionNumber then
		return;
	end
end

HearingAidInventoryTooltip = {
	versionNumber = versionNumber,
	drawForItems = {},
};

HearingAidInventoryTooltip.registerItem = function(fullType, modData, label)
	HearingAidInventoryTooltip.drawForItems[fullType] = {
		modData = modData,
		label = label,
	};
end
...
HearingAidInventoryTooltip.doOverride = function()
...
HearingAidInventoryTooltip.init = function()
	HearingAidInventoryTooltip.doOverride();
end

Events.OnGameStart.Add(HearingAidInventoryTooltip.init);
